...
export class ConversationModel extends window.Backbone
  ...
  async sendVerifySyncMessage(
    ...
    log.info('sendVerifySyncMessage-');
  ...
  async sendDeleteForEveryoneMessage(options: {
    ...
    log.info('sendDeleteForEveryoneMessage');
  ...
  async enqueueMessageForSend(
    ...
    // Sending message to conversation 001eb0a0-acff-481f-a7af-92b78ff56771
    //  (001eb0a0-acff-481f-a7af-92b78ff56771) with timestamp 1648875027224
    log.info(
  ...
  async updateExpirationTimer(
    ...
    log.info('updateExpirationTimer-');
    if (isGroupV2(this.attributes)) {
